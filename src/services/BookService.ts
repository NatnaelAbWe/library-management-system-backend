import BookDao, { IBookModel } from "../daos/BookDao.js";
import { IBook } from "../models/Book.js";
import { IPagination } from "../models/pagination.js";
...
export async function findbyBookById(id: string): Promise<IBookModel> {
  try {
